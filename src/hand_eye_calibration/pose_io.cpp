...
void convertTo4x4(vector<double> &poseVec, Eigen::Matrix4d &t)
{
    ...
    t(0, 0) = (double) m(0,0); t(0, 1) = (double) m(0,1); t(0, 2) = (double) m(0,2); t(0, 3) = poseVec[0];
    t(1, 0) = (double) m(1,0); t(1, 1) = (double) m(1,1); t(1, 2) = (double) m(1,2); t(1, 3) = poseVec[1];
    t(2, 0) = (double) m(2,0); t(2, 1) = (double) m(2,1); t(2, 2) = (double) m(2,2); t(2, 3) = poseVec[2];
    t(3, 0) = (double) 0; t(3, 1) = (double) 0; t(3, 2) = (double) 0; t(3, 3) = (double) 1;
